...
// WARNING bytesPerRecord for your sensor combination MUST TOTAL 1,2,4,8 or 16
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++   
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
// WARNING this can use alot of memory very quickly! - reccomend use with larger eeprom memory
...
//const char loggerConfiguration[] PROGMEM = "YOUR NAME HERE,1126400,4kEEprom,10kRef[6],NTC[7]&LDR[9]104cap,LED_GndGB_A0_A2";
//const char loggerConfiguration[] PROGMEM = "P 1127205L,1.8uA,1KuF fixed earlier issues?,2x64k(50&51),1.101v,NTC&64kLDR,LED_GndGB_A0_A2,1000uFrailCap,10Kref[D6]/NTC[D7]/LDR[D9]-104cap";
const char loggerConfiguration[] PROGMEM = "CN 1132260L,Si751,EEPR:64k@0x50 & 4K@0x57&,1.4uA,LED_GndGB_A0_A2,1.106v,rail200uF,UnitsMade4Max";

const char deploymentDetails[] PROGMEM =   "Lab0X: Investigating sensor X";

//#ifdef ReadNTC_6ref7ntc                         // also enable matching define in setup_sendboilerplate2serialMonitor() to print this info with your data
...
// no initialization needed for ReadNTC_6ref7ntc or ReadLDR_onD9
...
//  if(EEbytesOfStorage>4096){NOP;NOP;NOP;NOP;NOP;NOP;NOP;NOP;}                     // back to default 100khz I2C bus
    ...
    }else if (EEbytesOfStorage==65536){                                              // with larger eeproms you may need to keep the bus clock running -> but .idle FREEZES the 4k eeproms!
  ...
  if(EEbytesOfStorage==65536){  // 64 eeproms need more time for system recovery here
      // could pip the red LED to indicate EEprom memory save occured?
...
// ============================================================================================================
// ============================================================================================================
#endif //end of #if defined(ReadLDR_onD9) || defined(ReadNTC_6ref7ntc)
// ============================================================================================================
// ============================================================================================================
